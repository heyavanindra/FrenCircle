...
{
    /// <summary>
    /// Provides extension methods for registering the <see cref="FrenCircleDbContext"/> in the
    ...
    ///   </item>
    ///   <item>
    ///     <description>Sets EF Core migrations assembly to <c>FrenCircle.Api</c>.</description>
    ///   </item>
    ///   <item>
    ...
    /// Usage:
    /// <code>
    /// services.AddFrenCircleDbContext(Configuration, Environment);
    /// </code>
    /// </summary>
    public static class DbExtensions
    {
        /// <summary>
        /// Registers <see cref="FrenCircleDbContext"/> with Npgsql and configures provider- and environment-specific options.
        /// </summary>
